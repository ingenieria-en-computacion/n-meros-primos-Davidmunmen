...
.while:
    ...
    cmp ecx,[esp];compara que d sea menor a a
    jae _fin
    cmp dl,0 ;compara el residuo con 0
    je _fin
    add ecx,3 ;si no es igual d=d+3
    jmp .while
...
_primo:
    mov esi, msg3  ; Mensaje de número primo
    call print_str
    jmp _fin            ; Termina
_noesprimo
    mov esi, msg2  ; Mensaje de número primo
    call print_str
    jmp _fin            ; Termina
; ----------------------------------------------------------
